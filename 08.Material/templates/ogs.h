...
// FEATURE main.Application.CameraManipulator/Include
...
// FEATURE scene.simplePosition/Include
// FEATURE scene.simpleRotation/Include
...
// FEATURE scene.degreesToQuaternion/Impl
// FEATURE scene.nodeAtPosition/Impl
// FEATURE scene.quaternionToDegrees/Impl
// FEATURE scene.simplePosition/Impl
// FEATURE scene.simpleRotation/Impl
...
// FEATURE script.Environment/Begin
            // FEATURE script.Environment.SafeCall/Impl
...
// FEATURE main.Materials/Setup
// FEATURE main.Materials/TearDown
// FEATURE main.Materials/Impl
    // FEATURE main.Materials+createMaterial/Impl
    // FEATURE main.Materials+material/Impl
// FEATURE main.Materials/End
...
// FEATURE main.Application/Setup
            ...
            // FEATURE main.Application.CameraManipulator/Setup
            // FEATURE main.Application.Mouse/Setup
            // FEATURE main.Application.Materials/Setup
...
// FEATURE main.Application/TearDown
            ...
            // FEATURE main.Application.Materials/TearDown
...
// FEATURE main.Application/Impl
    ...
    // FEATURE main.Application.CameraManipulator/Impl
    // FEATURE main.Application.Lua/Impl
    // FEATURE main.Application.Materials/Impl
...
// FEATURE main.Example.08.Material/Title
...
// FEATURE main.Example/Setup
        ...
        // FEATURE main.Example.API.application.camera.nodeAtPosition/Setup
        // FEATURE main.Example.API.application.camera.position/Setup
        // FEATURE main.Example.API.application.camera.rotation/Setup
        // FEATURE main.Example.API.application.materials.createMaterial/Setup
        // FEATURE main.Example.API.application.materials.material.setShaders/Setup
        // FEATURE main.Example.API.application.materials.material.setUniform/Setup
        ...
        // FEATURE main.Example.API.application.nodes.node.position/Setup
        // FEATURE main.Example.API.application.nodes.node.rotation/Setup
        // FEATURE main.Example.API.application.nodes.node.setMask/Setup
        // FEATURE main.Example.API.application.nodes.node.setMaterial/Setup
